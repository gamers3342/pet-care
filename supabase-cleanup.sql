...
CREATE POLICY "Allow public select on service" ON public.service FOR SELECT USING (true);
CREATE POLICY "Allow public insert on service" ON public.service FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update on service" ON public.service FOR UPDATE USING (true);
CREATE POLICY "Allow public delete on service" ON public.service FOR DELETE USING (true);
...
INSERT INTO public.service (service_name, service_address, contact_no, area) VALUES
  ...
  ('Smart Doggy''s', 'Premchand Nagar, Bodakdev', '+91 79 2685 6666', 'Bodakdev'),
